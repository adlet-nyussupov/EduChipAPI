package com.moniumverse.educhip.app.ws.shared;
...
public class AmazonSES {
	...
	final String FROM = "moniumverse@gmail.com";

	// The subject line for the email.
	final String SUBJECT = "One last step to complete your registration with EduChipApp";
	...
	final String HTMLBODY = "<h1>Please verify your email address</h1>"
			...
			+ "<a href='http://ec2-13-49-138-158.eu-north-1.compute.amazonaws.com:8080/verification-service/email-verification.html?token=$tokenValue'>"
	...
	final String TEXTBODY = "Please verify your email address. "
			...
			+ " http://ec2-13-48-44-151.eu-north-1.compute.amazonaws.com:8080/verification-service/email-verification.html?token=$tokenValue"
			+ " Thank you! And we are waiting for you inside!";
	...
	public void verifyEmail(UserDto userDto) {
		...
		System.setProperty("aws.accessKeyId", "AKIASQ5YREFUDRUB6HGU");
		System.setProperty("aws.secretKey", "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");
		

		AmazonSimpleEmailService client = AmazonSimpleEmailServiceClientBuilder.standard().withRegion(Regions.EU_WEST_1)
				.build();

		String htmlBodyWithToken = HTMLBODY.replace("$tokenValue", userDto.getEmailVerificationToken()).replace("$nameValue", userDto.getFirstName());
