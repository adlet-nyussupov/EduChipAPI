...
@Entity(name = "DoctoralOpportunities")
public class DoctoralOpportunitiesEntity implements Serializable {

	private static final long serialVersionUID = -6327709726920683955L;
